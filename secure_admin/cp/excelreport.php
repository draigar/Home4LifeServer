...
if($_GET["report"]=="draw") {
	...
	header("Content-Disposition: attachment; filename=draw_report.xls");
...
if($_GET["report"]=="entry") {
	...
	header("Content-Disposition: attachment; filename=entry_report.xls");
...
if($_GET["report"]=="claim") {
	...
	header("Content-Disposition: attachment; filename=prizes_claims_report.xls");
