...
$_THISPAGENAME = 'sub_event_detail';
$_MENUID = 4;
$_SUB_MENU_ID =15;

$_LANG["HEADER"] ="Subscribe Event Detail";
$_LANG["TITLE"]	 = ucfirst($_OFFICAILSITENAME)." :: Subscribe Event Detail";
...
if(!empty($_SESSION['login']['userid']) && !IsPageAccessPermited($_SESSION['login']['permissions'],$_MENUID)){
	$_WEBPAGE['code']="unauthorize";
}

// logic
include_once($_DIR['admininc']['code'] . $_WEBPAGE['code'].'.php');
include_once($_DIR['admininc']['templ'] . $_WEBPAGE['code'].'.templ');
