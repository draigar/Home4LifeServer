...
$_THISPAGENAME = 'utility';
$_MENUID = 8;

$_LANG["HEADER"] ="Utility";
$_LANG["TITLE"]	 = ucfirst($_OFFICAILSITENAME)." :: Utility";
...
if(!empty($_SESSION['login']['userid']) && !IsPageAccessPermited($_SESSION['login']['subpermissions'],$_MENUID)){
