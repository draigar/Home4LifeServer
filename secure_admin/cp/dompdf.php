...
switch ( $sapi ) {
 ...
 default:
 	...
 	if ( isset($_GET["input_file"]) )
 		$file = "tmp/".basename(rawurldecode($_GET["input_file"]));
 	else
 	...
 	if ( isset($_GET["base_path"]) )
 		...
 		if($_GET["output_file"]) $outfile=$_GET["output_file"];		
 		else $outfile = "dompdf_out.pdf"; # Don't allow them to set the output file
