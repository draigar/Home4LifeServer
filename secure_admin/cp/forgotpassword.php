...
$_THISPAGENAME = 'forgotpassword';

$_LANG["TITLE"]	 = ucfirst($_OFFICAILSITENAME)." :: Forgot Password";
$_LANG["HEADER"] = "Forgot Password";
...
$doWeCheckLogin = check_login($_THISPAGENAME, 'loginadmin', 'no', 10, 'ADMIN');
