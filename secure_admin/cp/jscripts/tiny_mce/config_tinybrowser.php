...
$tinybrowser['path']['image'] = '/demo/bible2/useruploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/demo/bible2/useruploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/demo/bible2/useruploads/files/'; // Other files location
