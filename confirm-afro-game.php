...
$_THISPAGENAME='confirm-afro-game';
...
$content[0]="Confirm Afro Millions";
...
<table width="681px" border="0" cellspacing="0" cellpadding="0" align="center">
                          ...
                          <tr> 
                            ...
                            <td valign="top" background="<?=$_DIR['site']['url']?>images/img20.gif" align="center" style="background-repeat: repeat-y;border-top:1px solid #D3D3D3"><table width="681px" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <td valign="top" align="left"><table width="96%" border="0" cellspacing="0" cellpadding="0" align="center">
                                      ...
                                      <tr> 
                                        ...
                                        <td colspan="2" class="text"><p>Please confirm 
                                          ...
                                          that you wish to complete your purchase summarized on the right of your screen. The total amount of  
                                ...
                                The top prize for Vision Raffle Draw is <strong><img src="<?=$_DIR['site']['url']?>images/naira.gif"><?=$afro[6]?>



                                **</strong>, a guranteed weekly millionaire making Raffle game.</p>
                                      ...
                                      <tr> 
                                        ...
                                        <td  colspan="2" bgcolor="#F4F1CC" style="border-bottom:2px solid #CCCCCC;padding:8px;line-height:1.9em"><p><strong> 

Did you know that you can play up to 30 lines at a time using the "Add more lines" link on your Play slip?
                                      ...
                                      <tr> 
                                        ...
                                        <td width="37%"><a href="<?=$_DIR["site"]["url"]?>index<?=$atend?>"><img src="<?=$_DIR['site']['url']?>images/cancel.png" width="75" height="23" border="0"></a>&nbsp;&nbsp; 
                                          ...
                                          <a href="<?=$_DIR["site"]["url"]?>afro-millions<?=$atend."act".$_DELIM."editnairapslip"?>"><img src="<?=$_DIR['site']['url']?>images/make_changes.png" border="0"></a> 
                                        ...
                                        <td width="63%" bgcolor="#F6F6F6" style="padding:6px" valign="top">Remember, 
                                          ...
                                          - and must only play in a state where 



                                          it is lawful to do so</a><br/><br/><br/>
