...
if($_SERVER['REQUEST_METHOD']=="POST" && $_POST["Submit"]=="Submit") { 
	...
	$data="ticketnumber=".$ticketno."&action=CHKREST";
	$url = "http://www.visionlottery.com/gateway/apiresult.php";
	$ch = curl_init();
	...
	echo "<br />Request:<hr />";
	echo "<textarea style='width:600px;height:300px;'>Query String: ".$data."</textarea>";
	echo "<br />Response:<hr />";
	echo "<textarea style='width:600px;height:300px;'>".$response."</textarea>";
