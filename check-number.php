...
check_member_login('yes','MEMBER','','check-number'); //Check login



$_THISPAGENAME='check-number';
...
<tr> 
  ...
  <table width="681px" border="0" cellspacing="0" cellpadding="0" align="center"><tr><td><?php include("success.php"); ?></td></tr></table>
						...
						<tr>
						  ...
						  <td width="28%" valign="top" align="left"><table width="98%" border="0" cellspacing="1" cellpadding="1" align="center">
							  ...
							  <tr> 
								...
								<td style="line-height:1.5em;padding-left:10px;"><br> You are entered in Vision Number Draw:<br> 
									...
									<tr>
									  ...
									  <td valign="top" background="<?=$_DIR["site"]["url"]?>images/img89.gif" style="background-repeat:repeat-y"><table width="91%" border="0" cellspacing="1" cellpadding="1" align="center">
										  ...
										  <tr> 
											...
											<td class="linksign"><img src="<?=$_DIR["site"]["url"]?>images/naira.gif"><?=number_format($tprice+($my_basket['vision']?$naira[5]:0),2)?></td>
										  ...
										  <tr> 
											...
											<td valign="top" style="padding-top:8px"><a href="<?=$_DIR["site"]["url"]?>buy-slip<?=$atend?>"><img src="<?=$_DIR["site"]["url"]?>images/checkout.gif" width="129px" height="23px" border="0"></a></td>
										  ...
										  <tr>
											...
											<td><br/><a href="<?=$_DIR["site"]["url"]?>check-number<?=$atend."act".$_DELIM."savenumber".$baratend?>"><img src="<?=$_DIR["site"]["url"]?>images/save_number.gif" width="165" height="23" border="0"></a></td>
