							  ...
							  <td width="36%" align="left" valign="top" style="padding-left:10px;padding-top:10px;">
								...
								<tr> 
                                            ...
                                            <tr> 
                                              ...
                                              <td>Entered Vision Raffle: <?=$vision_number?"Yes":"No"?><br>
								  ...
								  <tr> 
									...
									<td height="177px" colspan="2" background="<?=$_DIR["site"]["url"]?>images/img90a.png" style="background-repeat: no-repeat"><table width="369" height="181" border="0" cellspacing="0" cellpadding="0"  align="left">
										...
										<tr> 
										  ...
										  <td height="47" colspan="2" align="left" style="padding-left:80px;"><span class="lottomoney"><img src="<?=$_DIR["site"]["url"]?>images/img39a.png" style="padding-top:5px;"><?=$prizeamt?></span></td>
...
<p>
									...
									Thank you for buying your ticket(s) online. Your Ticket Summary is on the left of your screen.Click on Continue below to view your ticket(s).
		  ...
		  <tr>
			...
			<td background="<?=$_DIR["site"]["url"]?>images/img83.gif" style="background-repeat:repeat-y" valign="top"><table width="93%" border="0" cellspacing="1" cellpadding="1" align="center">
				...
				<tr>
				  ...
				  <td class="text" style="padding-bottom:10px">Please call our Vision Lottery Customer Care Team on 01 45657 789</td>
