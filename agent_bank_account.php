...
include_once($_DIR['inc']['code'].'agent_bank_account.php'); //include code file
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td width="3%">&nbsp;</td>
				...
				<td height="48px" background="<?=$_DIR["site"]["url"]?>images/img42.png" style="background-repeat: no-repeat;padding-top:10px" valign="top">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
                          ...
                          <tr> 
                            ...
                            <td width="4%">&nbsp;</td>                            
               				...
               				<td class="vticket">Bank Details</td>
     ...
     <?php if($success) include("success.php"); ?>
          ...
          <td height="228" colspan="3"  valign="top" background="<?=$_DIR["site"]["url"]?>images/img43.png" style="background-repeat:repeat-y"> 
			...
			<table width="94%" border="0" cellspacing="2" cellpadding="0" align="center"  >
                ...
                <td width="18%" class="text11" align="left">Bank Address</td>                                  
                ...
                <td width="18%" align="left" class="text11">Account Name</td>
                ...
                <td width="19%" align="left" style="padding-right:5px;" class="text11">Account 
                  No</td>
                ...
                <td width="12%" align="center" style="padding-right:5px;" class="text11">Primary 
                </td>



								  
                <td width="16%" align="center" style="padding-right:5px;" class="text11">Action 
                </td>
								...
								<tr> 
                                  ...
                                  <td align="left"><?=stripslashes(@$val['address1'])?></td>                                  
                      			  ...
                      			  <td align="left"><?= stripslashes(@$val['account_name'])?></td>
								  ...
								  <td align="left" style="padding-right:5px;"><?=@$val['account_no']?></td>
								  ...
								  <td style="padding-right:5px;" align="center"><a href="<?=$_DIR['site']['url']."agent_bank_account.php?act=edit&id".$_DELIM.@$val['bank_id']?>">Edit</a>  |  <a href="javascript:if(confirm('Are you sure you want to delete record ?')) { location.href='<?=$_DIR['site']['url']."agent_bank_account.php?act=del&id".$_DELIM.@$val['bank_id']?>'; }">Delete</a>
				         </td>
