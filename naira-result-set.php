...
$_THISPAGENAME='naira-result-set';
...
<td width="31%" valign="top" align="left"><table width="83%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr> 
	  ...
	  <form name="frm" action="<?=$_DIR['site']['url']."result-naira-lotto".$atend?>" method="post">
	  ...
	  <table width="92%" border="0" cellspacing="0" cellpadding="0" align="center">
		  ...
		  <tr> 
			...
			<td valign="top" align="left" style="padding-top:6px"><table width="100%" border="0" cellspacing="1" cellpadding="1">
				...
				<tr> 
				  ...
				  <td width="88%" valign="top" align="left"><table width="94%" border="0" cellspacing="1" cellpadding="1">
					  ...
					  <tr>
						...
						<input type="hidden" name="<?="num".$j?>" value="<?=$_POST["num".$j]?>">
						...
						<input type="hidden" name="<?="num".($j+1)?>" value="<?=$_POST["num".($j+1)]?>">
		  ...
		  <tr> 
			...
			<td align="center" valign="top" style="padding:8px"><input type="image" src="<?=$_DIR['site']['url']?>images/make_changes.png" width="124" height="23" border="0"></td>
		  ...
		  <tr> 
			...
			<td align="center" style="padding:8px"><a href="javascript:void(0)" onClick="savenum('<?=$_SERVER['REQUEST_URI']?>')" class="link">Save my numbers</a><br><br><a href="#" class="link">Print numbers</a></td>
		  ...
		  <tr>
			...
			<td align="center" valign="top" style="padding:8px"><a href="javascript:void(0)" onClick="playnum('<?=$_SERVER['REQUEST_URI']?>')"><img src="<?=$_DIR['site']['url']?>images/play_number.png" border="0" width="161" height="23"></a></td>
...
<td width="68%" valign="top" align="left"><table width="469px" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
	  ...
	  <td height="5px" valign="top"><img src="<?=$_DIR['site']['url']?>images/img132.png" width="469" height="5"></td>
	...
	<tr>
	  ...
	  <td background="<?=$_DIR['site']['url']?>images/img134.png" style="background-repeat: repeat-y" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
		  ...
		  <tr>
			...
			<td valign="top" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr> 
				  ...
				  <td colspan="3" class="your_number" style="padding:5px">Your Match(s) explained</td>
				  ...
				  <td valign="top" align="left" style="padding-top:4px;padding-bottom:4px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						...
						<td width="72%" height="25">Result 
						  ...
						  for draw <?=strlen($naira_id[$i])<4?substr("0000",0,4-strlen($naira_id[$i])).$naira_id[$i]:$naira_id[$i]?> on   <span class="basket" style="color:#D70109"><?=$to_time[$i]?></span></td>



						<td width="28%"><a href="<?=$_DIR['site']['url']?>prize-breakdown-naira<?=$atend?>idx<?=$_DELIM."i".md5($naira_id[$i]).$baratend?>" class="link">Prize breakdown</a></td>
					  ...
					  <tr>
						...
						<td valign="top" style="padding-top:10px" class="text">Line <?=$line_number[$i]?><br><span class="new_title">Matched <?=$matchp?></span></td>
	...
	<tr>
	  ...
	  <td valign="top" height="5px"><img src="<?=$_DIR['site']['url']?>images/img133.png" width="469" height="5"></td>
