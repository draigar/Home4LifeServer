...
include_once($_DIR['inc']['code'].'sign-in.php'); //include code file
...
<tr> 
  ...
  <td valign="top"><table width="705px" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr> 
		...
		<td height="62" background="<?=$_DIR["site"]["url"]?>images/img66.gif" style="background-repeat:no-repeat; padding-left:20px" class="text7">Sign In</td>
				  ...
				  <tr> 
					...
					<table width="98%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
						  ...
						  <form id="formular" name="formular" class="formular" action="<?=$_DIR['site']['url']?>sign-in-step2<?=$atend.($_GET["pvs"]?"pvs".$_DELIM.$_GET["pvs"].$baratend:"")?>" method="post">
						  ...
						  <table width="99%" border="0" cellspacing="2" cellpadding="2">
							  ...
							  <tr> 
								...
								<td colspan="2"> <input type="text" class="validate['required','email'] textfield" name="txtUsername" id="txtUsername" value="<?=$_POST['txtUsername']?>" maxlength="255"> 
...
<strong>Remember,</strong> 
							  ...
							  <tr> 
								...
								<td colspan="2" valign="top"><a href="<?=$_DIR["site"]["url"]?>forgot-password<?=$atend?>" class="linksign">Forgot 
								...
								<td colspan="2" valign="top"><a href="<?=$_DIR["site"]["url"]?>forgot-security-code<?=$atend?>" class="linksign">Forgot 
