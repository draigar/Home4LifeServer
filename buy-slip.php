							...
							<tr> 
							  ...
							  <table width="99%" border="0" cellspacing="1" cellpadding="1">
								  ...
								  <tr> 
									...
									<td height="177px" colspan="2" background="<?=$_DIR["site"]["url"]?>images/img90.png" style="background-repeat: no-repeat"><table width="369" height="168" border="0" cellspacing="0" cellpadding="0"  align="left">
										...
										<tr> 
										  ...
										  <td colspan="2" align="left" height="22px"  class="green" valign="top" style="padding-left:85px;line-height:1.5em"><?=$naira[0]?></td>

										</tr>

										<tr> 

										  <td height="47" colspan="2" align="left" style="padding-left:80px;"><span class="lottomoney"><img src="<?=$_DIR["site"]["url"]?>images/img39.png" align="top">&nbsp;<?=$naira[1]?></span></td>
												...
												<td width="44%" valign="top" align="left"> 
												  ...
												  <table width="135" border="0" cellpadding="0" cellspacing="0">
													...
													<tr> 
													  ...
													  <td width="39" height="29" valign="middle" align="center" class="num2"><?=$naira[2]["fullDays"]?></td>

													  <td width="11"><img src="<?=$_DIR["site"]["url"]?>images/spacer.gif"></td>

													  <td width="35" valign="middle" class="num2" align="center"><?=$naira[2]["fullHours"]?></td>

													  <td width="13"><img src="<?=$_DIR["site"]["url"]?>images/spacer.gif"></td>

													  <td width="37" valign="middle" class="num2" align="center"><?=$naira[2]["fullMinutes"]?></td>
								  ...
								  <tr> 
									...
									<td colspan="2" align="right" valign="top" style="padding-right:76px;font-size:13px"><strong><?=$naira[3]?><img src="<?=$_DIR["site"]["url"]?>images/spacer.gif" width="8px">Days<img src="<?=$_DIR["site"]["url"]?>images/spacer.gif" width="15px">Hours<img src="<?=$_DIR["site"]["url"]?>images/spacer.gif" width="15px">Mins</strong></td>
								  ...
								  <tr> 
									...
									<td width="67%" ><br><a href="javascript:if(confirm('Are you sure you wish to cancel all play slips?')){self.location.href='<?=$_DIR["site"]["url"]."buy-slip".$atend."act".$_DELIM."cancelps".$baratend?>'}" class="linksign">Cancel 
