...
include_once($_DIR['inc']['code'].'agent-forgot-password.php'); //include code file
				  ...
				  <tr> 
					...
					<table width="98%" height="40" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr> 
						    ...
						    <td width="50%" style="padding-left:8px" class="white">Forgot Password</td>
						...
						<tr>
						  ...
						  <table width="99%" border="0" cellspacing="2" cellpadding="2">
							  ...
							  <tr> 
								...
								<td colspan="2"> <input type="text" class="validate['required'] textfield" name="txtUsername" id="txtUsername" value="<?=$_POST['txtUsername']?>" maxlength="60"> 
								<br><?=$_MSG[1]?>
