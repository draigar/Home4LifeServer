...
<tr> 
          ...
          <td height="72" background="<?=$_DIR["site"]["url"]?>images/img66.gif" style="background-repeat:no-repeat; padding-left:20px" class="vticket">Shillings 
                                ...
                                <tr> 
                                  ...
                                  <td width="40%" valign="top"><b><font face="Arial" size="+2" color="Green">Are you a winner?</font></b>
                                   ...
                                   <br>
                                    ...
                                    Jackpot for this draw<br><font face="Arial" size="+2" color="Green"><b>KES <?=number_format($jackpot,2)?></b></font>
                                      ...
                                      <tr> 
                                        ...
                                        <td valign="top" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr> 
                                              ...
                                              <td width="25%" height="37px" background="<?=$_DIR['site']['url']?>images/img115.gif" class="num" style="background-repeat:repeat-x">KES per winner
                                            ...
                                            <tr bgcolor="#FAFAFA"> 
                                              ...
                                              <td>KES <font color="green"><?=number_format($result[$i][2],2)?></font></td>
                                              ...
                                              <td>KES<font color="green"><?=number_format($result[$i][1],2)?></font></td>
                                            ...
                                            <tr> 
                                              ...
                                              <td bgcolor="#DCDADA" class="text12"> <font face="Arial" color="Green"><b><font size="+1">KES<?=$totfundpz?></font></b></font></td>
