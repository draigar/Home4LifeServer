...
$content[0]="Agent Locator";
$content[2]="Agent Locator";
include_once($_DIR['inc']['code'].'agentlocator.php'); //include code file
					...
					<table width="98%" border="0" cellpadding="0" cellspacing="0">
						...
						?>
						  ...
						  <table width="94%" border="0" cellspacing="2" cellpadding="4" align="center">
							  <tr> 
								<td colspan="3" class="text9" style="background-image: url(<?=$_DIR['site']['url']?>images/dot.gif);background-position: left bottom;background-repeat: repeat-x;"><?=stripslashes(@$val['fullname'])?><br></td>
							  </tr>
							  <tr> 
								<td width="20%"><b>Address</b></td>
								<td width="5%"><img src="<?=$_DIR["site"]["url"]?>images/arrow.gif" width="4" height="6"></td>
								<td width="70%" align="left"><?=stripslashes(@$val['fulladdress'])?></td>
							  </tr>
							  <tr> 
								<td><b>City</b></td>
						...
						<? }else{ ?>
							<tr> 
										  <td align="center" valign="top" class="text11" colspan="2">Sorry, No 
											Record Found.</td>
							</tr>
							<?php } ?>
					  </table></td>
