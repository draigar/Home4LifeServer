<?php
$sql="select c.lotto_numbers,c.ne_id,e.entry_id,e.vision_numbers,t.ticket_no,l.match0,l.match1,l.match2,l.match3,l.match4,l.match5,l.match6,l.match7,l.draw_number,
...
where l.status='D' and t.ticket_no='".$ticketno."' group by c.ne_id   
having ( 
