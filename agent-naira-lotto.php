...
$formvalidation=true;
include_once($_DIR['inc']['code'].'agent-naira-lotto.php'); //include code file
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <td width="75%" valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="48px" background="<?=$_DIR["site"]["url"]?>images/img42.png" style="background-repeat: no-repeat;padding-top:10px" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                          <tr> 
                            <td width="4%">&nbsp;</td>                            
               				<td class="vticket">Naira Lotto Entries</td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr>
		  ...
		  <select name="ff1" class="validate['required']">
			  ...
			  <td width="1">&nbsp;</td>
			  <td width="44" class="text11">To</td>
			  <td width="274" class="text11">
			   ...
			   <select name="tt3" class="validate['required']">
					...
					<?php } ?>
                                ...
                                <tr> 
                                  <td>&nbsp;</td>
                                  <td colspan="3">&nbsp;</td>
                                  <td width="274" align="center"><input type="image" border="0" src="<?=$_DIR["site"]["url"]?>images/search.gif" width="77" height="23"></td>
                                </tr>
								 <tr> 
                                  <td colspan="6"><hr></td>
                                </tr>
						...
						?>
                          <tr> 
                            <td height="25px" bgcolor="#F6F6F6" style="border-bottom:2px solid #CCCCCC;padding-left:5px" align="left" class="text12">Naira Entries</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="0">
                                <tr> 
                                  <td width="174" height="35px" class="text11" style="padding-left:5px" align="left">NL-ID</td>                                  
                      			  <td width="233" align="left" class="text11">Date/Time Entered</td>
								  <td width="107" align="center" class="text11">Ticket No</td>
									<td width="107" align="center" class="text11">Method</td>
								  <td width="159" align="center" class="text11">Entries</td>
								  <td width="159" align="center" class="text11">Vision No</td>
								  <td width="159" align="center" class="text11">Action</td>
                                </tr>
									<?php 			
									...
									?>
								<tr> 
                                  <td align="left" style="padding-left:5px"><?=@$val['nl_id']?></td>                                  
								...
								<tr> 
                                  <td colspan="7" bgcolor="#CCCCCC"><img src="<?=$_DIR["site"]["url"]?>images/spacer.gif"></td>
                                </tr>
										<?php  
												}
										?>
