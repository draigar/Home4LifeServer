...
$sql="select c.lotto_numbers,e.entry_id,e.vision_numbers,c.ne_id,t.ticket_no,l.match0,l.match1,l.match2,l.match3,l.match4,l.match5,l.match6,l.draw_number,
...
where l.status='D' and l.naira_id='".$_GET["id"]."'
having (
