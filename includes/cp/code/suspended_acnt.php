...
//==============Code added by Jay=========================
	...
	$getAllIdsqry 			= $_DIR['admininc']['queries']."getsuspended_acntids.sql";	//This will spcify the fiel which will give us only the ids of the country
	...
	$getDataByIdsqry 		= $_DIR['admininc']['queries']."getsuspended_acntbyids.sql";	//This is the query file which will give us the country inforation by passing the ids got from just above string
...
$_sql="select `condition`,value from gcm where condition_type='MEM_STATUS' and `condition` not in('U','S') order by `condition`";
