...
//==============Code added by Jay=========================
	...
	$getAllIdsqry 			= $_DIR['admininc']['queries']."getnaira_listingids.sql";	//This will spcify the fiel which will give us only the ids of the country
	...
	$getDataByIdsqry 		= $_DIR['admininc']['queries']."getnaira_listingbyids.sql";	//This is the query file which will give us the country inforation by passing the ids got from just above string
...
if ($_GET["success"]==1)
	$success = "Draw of Naira Lotto has been successfully Saved.";	
if ($_GET["success"]==2)
	$success = "The Naira Lotto has been successfully Updated.";
if ($_GET["success"]==3)
	$success = "The Naira Lotto has been successfully Deleted.";
if ($_GET["success"]==4)
	$success = "The Result of Naira Lotto has been successfully Declared and Notified to all users.";
?>