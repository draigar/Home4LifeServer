...
if($rs) $rs->close();
$sql="select c.lotto_numbers,e.entry_id,e.vision_numbers,l.match0,l.match1,l.match2,l.match3,l.match4,l.match5,l.match6,l.draw_number,
l.draw_date,l.matchz3,l.matchz4,l.matchz5,
...
having ( 
	( 
				( e.method_id='T' and (matchx1+matchx2+matchx3+matchx4+matchx5+matchx6)>=3 )  
				or 
				( e.method_id!='T' and (matchx1+matchx2+matchx3+matchx4+matchx5+matchx6)>3 ) 
			)
	OR 
