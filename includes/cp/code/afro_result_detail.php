...
$sql="select c.lotto_numbers,e.entry_id,e.vision_numbers,c.ne_id,t.ticket_no,l.match0,l.match1,l.match2,l.match3,l.match4,l.match5,l.match6,l.match7,l.draw_number,
l.draw_date,l.matchz3,l.matchz4,l.matchz5,l.matchz6,
...
where l.status='D' and l.afro_id='".$_GET["id"]."' group by c.ne_id
having (
	( (matchx1+matchx2+matchx3+matchx4+matchx5+matchx6+matchx7)>=3 )
