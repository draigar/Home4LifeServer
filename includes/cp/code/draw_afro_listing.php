...
//==============Code added by Jay=========================
	...
	$getAllIdsqry 			= $_DIR['admininc']['queries']."getdrawafro_listingids.sql";	//This will spcify the fiel which will give us only the ids of the country
	...
	$getDataByIdsqry 		= $_DIR['admininc']['queries']."getdrawafro_listingbyids.sql";	//This is the query file which will give us the country inforation by passing the ids got from just above string
...
if ($_GET["success"]==1)
	$success = "Afro Lotto Has Been Successfully Added.";
if ($_GET["success"]==2)
	$success = "Afro Lotto Has Been Successfully Updated.";
if ($_GET["success"]==3)
	$success = "Afro Lotto Has Been Successfully Deleted.";
