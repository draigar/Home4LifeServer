...
//==============Code added by Jay=========================
	...
	$getAllIdsqry 			= $_DIR['admininc']['queries']."getpendingagentids.sql";	//This will spcify the fiel which will give us only the ids of the country
	...
	$getDataByIdsqry 		= $_DIR['admininc']['queries']."getpendingagentbyids.sql";//This is the query file which will give us the country inforation by passing the ids got from just above string
	$doPrevNext 			= true;												//This says do we need next and previous button
	$hiddenPostVar			= array("num"=>$_POST["num"],"mid"=>$_POST["mid"],"id"=>$_POST["id"],"txtFirst"=>$_POST["txtFirst"],"txtLast"=>$_POST["txtLast"],"txtEmail"=>$_POST["txtEmail"],"txtBName"=>$_POST["txtBName"]);											//This will have name=>value pair of additional hidden form fields to be passed
