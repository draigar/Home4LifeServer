...
//==============Code added by Jay=========================
	...
	$getAllIdsqry 			= $_DIR['inc']['queries']."get_claimpointids.sql";	//This will spcify the fiel which will give us only the ids of the country
	...
	$getDataByIdsqry 		= $_DIR['inc']['queries']."get_claimpointbyids.sql";	//This is the query file which will give us the country inforation by passing the ids got from just above string
