...
if($_GET["idx"]) {
  ...
  $qry="SELECT e.afro_id,t.ticket_no,t.nt_id,t.entry_id,t.price,e.method_id,e.draws,e.weeks,e.vision_numbers,e.vision_price,gcm.value,
	...
	LEFT JOIN afro_entry_child h ON h.nt_id=t.nt_id
