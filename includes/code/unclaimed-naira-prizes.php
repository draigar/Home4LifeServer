...
if($rs) $rs->close();
$sql="select c.lotto_numbers,e.entry_id,e.vision_numbers,l.match0,l.match1,l.match2,l.match3,l.match4,l.match5,l.match6,l.draw_number,l.draw_date,
...
having ( 
	( (matchx1+matchx2+matchx3+matchx4+matchx5+matchx6)>=5 )
