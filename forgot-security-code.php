...
include_once($_DIR['inc']['code'].'forgot-security-code.php'); //include code file
	  ...
	  <tr> 
		...
		<td  background="<?=$_DIR["site"]["url"]?>images/img55.gif" align="center" style="background-repeat: repeat-y;" valign="top" ><table width="98%" border="0" cellspacing="1" cellpadding="1">
            <tr>
			    ...
			    <td class="text">Please enter your Vision Account's email address 
                  below to recover your forgotten security code. If you're a new 
                  user, click 'Open an Account' to securely enter your details.<br/>
                  <br/></td>
