...
include_once($_DIR['inc']['code'].'news.php'); //include code file
...
<table width="100%" border="0" cellspacing="4" cellpadding="4">
        ...
        <tr> 
          ...
          <td height="25px" id="content" class="headline"><a href="<?=$_DIR['site']['url']?>news_details<?=$atend?>id<?=$_DELIM.@$val['news_id'].$baratend?>" class="tileHeadline"><?=@$val['title']?></A></td>

        </tr>

        <tr> 

          <td height="25px" class="text"><em style="color:red;"><?php echo $val['creation_date']; ?></em><br /><?=substr(strip_tags(@$val['content']),0,250)?><em style="color:blue;">..&raquo;&raquo;</em></td>
        ...
        <tr> 
          ...
          <td align="center" valign="top" class="text11">Sorry, No New Updates.</td>
